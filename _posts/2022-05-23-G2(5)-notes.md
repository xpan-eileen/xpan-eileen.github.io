...
\\g = x_{\alpha + \beta}(1)x_{-\alpha - \beta}(4), & N \cap N^g = H \cap H^g \cong C_5 \rtimes D_5.\mathrm{Alt}_5.
\end{align}
$$
...
A quick computation shows that this is indeed the case in our example $G_2(5)$. But what about in general, do we still have the same or analogous results for $G_2(p)$ for odd primes $p$?
