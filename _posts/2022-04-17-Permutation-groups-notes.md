...
5. $G \cong T^k. (\mathrm{Out}(T) \times \mathrm{Sym}_k)$ with $n = \vert T\vert ^{k-1}, k \ge 2$, and $T$ a nonabelian simple group. (Groups of diagonal type; in fact proved in 2020, is a stabiliser of some „nice“ group with some diagonal structure.)
