...
## Maximal subgroups of type $A2.2$
...
$$
\begin{align} g = x_{\alpha + \beta}(1)x_{2\alpha + \beta}(1), &\   &  N \cap N^g \cong \mathrm{He}(5).2, &\ H \cap H^g \cong \mathrm{He}(5);
...
\\g = x_{\alpha + \beta}(1)x_{-\alpha - \beta}(4), &\  & N \cap N^g = H \cap H^g \cong C_5 \rtimes D_5.\mathrm{Alt}_5. \end{align}
$$
