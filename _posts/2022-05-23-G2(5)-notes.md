...
- Comparing the intersections $H \cap H^g$ and $H_0 \cap H_0^g$,
  ...
  - in the case where $g = x_{\alpha+\beta}(1)x_{-\alpha-\beta}(\frac{1}{2}(p - 1))$, the intersection $H \cap H^g \cong 4.(H_0 \cap H_0^g)$.
  - in all other cases $H \cap H^g \cong 2.(H_0 \cap H_0^g).2$.
